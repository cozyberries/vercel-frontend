...
/**
 * Thin 'use client' boundary that lazily loads ImpersonationBanner with ssr:false.
 *
 * WHY THIS EXISTS — Next.js 15 HMR race (see CLAUDE.md and PwaUpdateHandlerClient):
...
const ImpersonationBanner = dynamic(() => import('./impersonation-banner'), {
  ssr: false,
})
