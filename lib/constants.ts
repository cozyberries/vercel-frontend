...
export const UPI_PHONE_NUMBER = process.env.NEXT_PUBLIC_UPI_PHONE;

/** Static QR code image URL for UPI payments. */
export const STATIC_QR_CODE_URL =
  "https://aqvcyyhuqcjnhohaclib.supabase.co/storage/v1/object/public/media/qr-code/qr-code-image.jpg";
