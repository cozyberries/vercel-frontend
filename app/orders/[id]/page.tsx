...
import type { Order, Payment, OrderStatus, PaymentStatus } from "@/lib/types/order";
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="font-medium">{orderService.formatOrderStatus(order.status)}</div>
                    ...
                    <div key={payment.id} className="border border-gray-100 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${paymentStatusColors[payment.status]}`}>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="font-mono">{payment.internal_reference}</span>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Gateway: </span>
                          <span className="capitalize">{payment.gateway_provider}</span>
                        </div>
                        <div>
